...
def add_watermark_and_address(input_pdf_path, current_document_number, total_documents, skip_address=False):
    ...
    for i in range(total_pages):
        ...
        can.rect(201, 158, 500, 15, fill=True, stroke=False)
        can.setFillColor(black)  # 글자색 검정으로 설정
        can.drawString(201, 158, "Registered : N° 2477-B")
        ...
        can.rect(201, 353, 500, 15, fill=True, stroke=False)

        # 가린 부분에 BOOSTIN 글자 추가
        can.setFillColor(black)
        can.drawString(201, 353, "BOOSTIN ADVANCE")
...
def main():
    ...
    while current_document_number <= total_documents:
        ...
        temp_pdf_file = os.path.join(
            "D:\\#.Secure Work Folder\\BIG\\Toy\\24~28Y\\240318 부스틴 Shipping mark 출력\\pdf\\temp", "temp.pdf")
    ...
    combined_pdf_path = os.path.join("D:\\#.Secure Work Folder\\BIG\\Toy\\24~28Y\\240318 부스틴 Shipping mark 출력\\out",
