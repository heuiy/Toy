...
# 아래 2가지 수정 필요
# Consignee 회사명 : MERCH SHARP & DOHME SAUDE ANIAML LTDA
# Product 이름 수정 : BOOSTIN-PLUS > BOOSTIN
...
def add_watermark_and_address(input_pdf_path, current_document_number, total_documents, batch_number, skip_address=False):
   ...
   for i in range(total_pages):
       ...
       if not skip_address:
           ...
           can.rect(200, 490, 600, 30, fill=True, stroke=False)
           can.rect(200, 450, 600, 30, fill=True, stroke=False)
           can.rect(200, 330, 600, 30, fill=True, stroke=False)

           can.setFillColor(black)
           can.drawString(205, 500, "MERCH SHARP & DOHME SAUDE ANIAML LTDA")
           can.drawString(205, 460, "SAO PAULO - BRAZIL RUA EDGAR MARCHIORI, 255")
           can.drawString(205, 340, "BOOSTIN")
