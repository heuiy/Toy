...
can.rect(202, 457, 500, 19, fill=True, stroke=False)
can.setFillColor(black) # 글자색 검정으로 설정
# can.drawString(200, 460, address) # 주소 추가
# can.drawString(218, 409, address) # 주소 추가
# can.drawString(218, 440, address) # 주소 추가
can.drawString(202, 459, address) # 주소 추가
